...
public:
    ...
    const std::string& getName() const { return *name; } //getter
...
public:
    ...
    bool isConnectedSubgraphMap() const;
...
public:
    ...
    private:
    bool parseMapSection(std::ifstream& file, Map* map);
    bool parseContinentsSection(std::ifstream& file, Map* map);
    bool parseTerritoriesSection(std::ifstream& file, Map* map);
};
