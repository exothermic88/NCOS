...
complete -c qemu-system-i386 -o fdb -d 'Use file as floppy disk 0/1 image (see the \\X\'tty: link #disk-images\'\\%Disk I…'
...
complete -c qemu-system-i386 -o gdb -d 'Accept a gdb connection on device dev (see the \\X\'tty: link #gdb-usage\'\\%GDB …'
complete -c qemu-system-i386 -s s -d 'Shorthand for -gdb \\X\'tty: link tcp::1234\'\\%tcp::1234\\X\'tty: link\', i. e'
...
complete -c qemu-system-i386 -o semihosting -d 'Enable \\X\'tty: link #semihosting\'\\%Semihosting\\X\'tty: link\' mode (ARM, M68K, …'
complete -c qemu-system-i386 -o semihosting-config -d 'Enable and configure \\X\'tty: link #semihosting\'\\%Semihosting\\X\'tty: link\' (AR…'
