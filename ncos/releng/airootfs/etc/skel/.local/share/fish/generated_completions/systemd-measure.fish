...
complete -c systemd-measure -l linux -l osrel -l cmdline -l initrd -l ucode -l splash -l dtb -l uname -l sbat -l pcrpkey -d 'When used with the calculate or sign verb, configures the files to read the u…'
...
complete -c systemd-measure -l private-key-source -d 'As an alternative to --public-key= for the sign command, these switches can b…'
