...
complete -c scanimage -s f -l formatted-device-list -d 'works similarly to  --list-devices , but requires a format string'
...
complete -c scanimage -s B -l buffer-size -d 'changes input buffer size from the default of 1MB to  size KB'
